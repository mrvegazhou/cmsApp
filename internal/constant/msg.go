...
const (
	...
	ARTICLE_UPDATE_COMMENT_COUNT_ERR = "更新文章评论总数失败"
	...
	ARTICLE_COMMENT_PAGE_ERR          = "评论列表无法获取"
	ARTICLE_COMMENT_CURRENT_TIME_ERR  = "评论列表的时间参数错误"
	ARTICLE_REPLY_USER_EMPTY_ERR      = "评论人不能为空"
	ARTICLE_REPLY_CONTENT_EMPTY_ERR   = "评论内容不能为空"
	ARTICLE_REPLY_CONTENT_LEN_ERR     = "评论字数超过%d"
	ARTICLE_REPLY_COMMENT_ID_ERR      = "评论不存在"
	ARTICLE_REPLY_ID_ERR              = "评论不存在"
	ARTICLE_REPLY_SAVE_ERR            = "保存评论失败"
	ARTICLE_COMMENT_IMG_SRC_ERR       = "保存评论图片错误"
	ARTICLE_COMMENT_REPLY_USERS_ERR   = "获取评论人错误"
